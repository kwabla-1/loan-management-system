<?php 
    class Borrower{
        ...
        {
            $sql = "DELETE FROM borrower WHERE b_id = $borrowerID";
            $query = $con->prepare($sql);
            $query->execute();
